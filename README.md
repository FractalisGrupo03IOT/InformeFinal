...
| Sprint #                       | Sprint 03                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sprint Planning Background** | En el Sprint 3, el equipo se enfoca en implementar y mejorar las funcionalidades clave de GreenTools para usuarios finales, optimizar la administración en la aplicación web y fortalecer el backend para asegurar un rendimiento robusto y escalable. El equipo prioriza las historias de usuario relacionadas con la configuración de alertas, notificaciones, reportes avanzados, autenticación, permisos, funcionalidades embebidas y optimización del backend distribuido. |
| **Date**                       | 2024-11-17                                                                                                                                                                                                                                                                                                                                                                                        |
| **Time**                       | 10:00 AM                                                                                                                                                                                                                                                                                                                                                                                          |
| **Location**                   | Reunión virtual (Zoom)                                                                                                                                                                                                                                                                                                                                                                            |
| **Prepared By**                | Franco Yance                                                                                                                                                                                                                                                                                                                                                                                      |
| **Attendees**                  | Franco Yance, Lino Quenta, Miguel Angel, Giovanni Andrés, Jean Patrick                                                                                                                                                                                                                                                                                                                           |
| **Sprint n-2 Review**          | En el Sprint 2, se implementaron funcionalidades clave en la Web App, Mobile App, y se avanzó en la integración de dispositivos IoT y en el backend. El equipo revisó los avances, identificó áreas de mejora y ajustó las tareas para el Sprint 3 para enfocarse en funcionalidades avanzadas y optimización del sistema.                                                                                                   |
| **Sprint n-1 Retrospective**   | El equipo identificó la necesidad de mejorar la automatización de tareas y reforzar las pruebas unitarias e integradas para asegurar la calidad del sistema. Se acordó aumentar la colaboración entre desarrolladores y mejorar la documentación de las APIs y funcionalidades implementadas.                                                                                                                     |

#### Sprint Goal & User Stories

| **Sprint Goal**         | Implementar y optimizar funcionalidades clave para mejorar la gestión de cultivos, notificaciones avanzadas, reportes detallados, seguridad en el acceso y optimización del backend, asegurando una experiencia robusta y escalable para los usuarios de GreenTools. La meta es alcanzar una integración completa de las nuevas funcionalidades y garantizar la estabilidad y rendimiento del sistema bajo carga. |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sum of Story Points** | 94 Story Points                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Sprint n Velocity**   | 94 Story Points                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |

#### 6.2.3.2. Sprint Backlog 3

| User Story | User Story Title                                           | Task ID | Task Title                                              | Description                                                                                      | Estimation (Hours) | Assigned To | Status |
| ---------- | ---------------------------------------------------------- | ------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------ | ----------- | ------ |
| EP2/US5    | Configuración de alertas críticas                          | T1      | Diseñar la funcionalidad de alertas críticas            | Diseñar cómo se manejarán las alertas críticas en el sistema                                     | 4                  | Miguel      | To Do  |
| EP2/US5    | Configuración de alertas críticas                          | T2      | Implementar la lógica de detección de condiciones críticas | Desarrollar la lógica para identificar condiciones críticas en los cultivos                      | 4                  | Giovanni    | To Do  |
| EP2/US5    | Configuración de alertas críticas                          | T3      | Desarrollar interfaz de usuario para configuración de alertas | Crear la interfaz donde los usuarios puedan configurar alertas críticas                           | 4                  | Jean        | To Do  |
| EP2/US5    | Configuración de alertas críticas                          | T4      | Realizar pruebas unitarias y de integración              | Ejecutar pruebas para asegurar que las alertas funcionan correctamente                           | 4                  | Lino        | To Do  |
| EP2/US8    | Configuración avanzada de notificaciones en la app móvil   | T5      | Definir tipos de notificaciones personalizables          | Determinar los diferentes tipos de notificaciones que los usuarios pueden personalizar          | 3                  | Miguel      | To Do  |
| EP2/US8    | Configuración avanzada de notificaciones en la app móvil   | T6      | Diseñar la interfaz de configuración de notificaciones   | Crear la interfaz de usuario para la configuración avanzada de notificaciones                   | 4                  | Giovanni    | To Do  |
| EP2/US8    | Configuración avanzada de notificaciones en la app móvil   | T7      | Implementar la lógica de personalización de notificaciones | Desarrollar la lógica para que los usuarios puedan personalizar las notificaciones según sus necesidades | 4                  | Jean        | To Do  |
| EP2/US8    | Configuración avanzada de notificaciones en la app móvil   | T8      | Realizar pruebas de funcionalidad y usabilidad            | Ejecutar pruebas para asegurar que las notificaciones personalizadas funcionan correctamente y son fáciles de usar | 4                  | Lino        | To Do  |
| EP3/US5    | Exportación de reportes en formato CSV desde la aplicación web | T9      | Diseñar la estructura de los reportes CSV                 | Definir la estructura y formato de los reportes CSV que se exportarán                           | 3                  | Miguel      | To Do  |
| EP3/US5    | Exportación de reportes en formato CSV desde la aplicación web | T10     | Implementar la funcionalidad de exportación en el backend | Desarrollar la lógica en el backend para generar y exportar los reportes en formato CSV          | 4                  | Giovanni    | To Do  |
| EP3/US5    | Exportación de reportes en formato CSV desde la aplicación web | T11     | Desarrollar la interfaz de usuario para exportar reportes   | Crear la interfaz en la aplicación web que permita a los usuarios exportar reportes en CSV       | 4                  | Jean        | To Do  |
| EP3/US5    | Exportación de reportes en formato CSV desde la aplicación web | T12     | Realizar pruebas de exportación con diferentes datasets      | Ejecutar pruebas utilizando diferentes conjuntos de datos para garantizar la funcionalidad de exportación | 4                  | Lino        | To Do  |
| EP3/US7    | Gestión de notificaciones de alertas en la aplicación web    | T13     | Diseñar el sistema de gestión de notificaciones            | Definir cómo se gestionarán las notificaciones de alertas en la aplicación web                   | 4                  | Miguel      | To Do  |
| EP3/US7    | Gestión de notificaciones de alertas en la aplicación web    | T14     | Implementar la lógica para recepción y visualización de alertas | Desarrollar la lógica que permite recibir y mostrar alertas en la aplicación web                  | 4                  | Giovanni    | To Do  |
| EP3/US7    | Gestión de notificaciones de alertas en la aplicación web    | T15     | Desarrollar la interfaz de usuario para gestión de notificaciones | Crear la interfaz donde los usuarios puedan gestionar sus notificaciones de alertas              | 4                  | Jean        | To Do  |
| EP3/US7    | Gestión de notificaciones de alertas en la aplicación web    | T16     | Realizar pruebas de notificaciones en diferentes escenarios | Ejecutar pruebas para asegurar que las notificaciones funcionan correctamente en diversos escenarios | 4                  | Lino        | To Do  |
| EP4/US5    | Autenticación y permisos de usuarios                        | T17     | Diseñar el esquema de autenticación y permisos             | Definir cómo se manejará la autenticación y los permisos de usuarios en el sistema              | 4                  | Miguel      | To Do  |
| EP4/US5    | Autenticación y permisos de usuarios                        | T18     | Implementar el sistema de autenticación de usuarios         | Desarrollar la funcionalidad de inicio de sesión y registro de usuarios                         | 4                  | Giovanni    | To Do  |
| EP4/US5    | Autenticación y permisos de usuarios                        | T19     | Desarrollar la lógica de asignación de permisos              | Crear la lógica que asigna permisos específicos a los usuarios según sus roles                 | 4                  | Jean        | To Do  |
| EP4/US5    | Autenticación y permisos de usuarios                        | T20     | Integrar la autenticación con la interfaz de usuario         | Conectar la funcionalidad de autenticación con las vistas de la interfaz de usuario             | 4                  | Franco      | To Do  |
| EP4/US5    | Autenticación y permisos de usuarios                        | T21     | Realizar pruebas de seguridad y acceso                       | Ejecutar pruebas para asegurar que la autenticación y los permisos funcionan correctamente y son seguros | 4                  | Lino        | To Do  |
| EP4/US6    | Control de acceso basado en roles en el backend              | T22     | Definir los roles y permisos asociados                      | Establecer los diferentes roles de usuario y los permisos que cada uno tendrá                   | 4                  | Miguel      | To Do  |
| EP4/US6    | Control de acceso basado en roles en el backend              | T23     | Implementar la lógica de control de acceso en el backend      | Desarrollar la funcionalidad que verifica los permisos de los usuarios en el backend            | 4                  | Giovanni    | To Do  |
| EP4/US6    | Control de acceso basado en roles en el backend              | T24     | Integrar el control de acceso con la base de datos            | Conectar la lógica de control de acceso con la base de datos para verificar permisos          | 4                  | Jean        | To Do  |
| EP4/US6    | Control de acceso basado en roles en el backend              | T25     | Desarrollar middleware para verificar permisos                | Crear middleware que intercepta las solicitudes y verifica los permisos de los usuarios        | 4                  | Franco      | To Do  |
| EP4/US6    | Control de acceso basado en roles en el backend              | T26     | Realizar pruebas de acceso con diferentes roles                | Ejecutar pruebas para asegurar que los permisos funcionan correctamente según los roles asignados | 4                  | Lino        | To Do  |
| EP4/US7    | Soporte para múltiples bases de datos en el backend          | T27     | Diseñar la arquitectura para soportar múltiples bases de datos | Definir cómo se gestionarán y estructurarán las múltiples bases de datos en el backend          | 4                  | Miguel      | To Do  |
| EP4/US7    | Soporte para múltiples bases de datos en el backend          | T28     | Configurar conexiones a bases de datos adicionales            | Establecer las conexiones necesarias para las nuevas bases de datos                           | 4                  | Giovanni    | To Do  |
| EP4/US7    | Soporte para múltiples bases de datos en el backend          | T29     | Implementar lógica de selección de base de datos según contexto | Desarrollar la lógica que selecciona la base de datos adecuada según el contexto de la solicitud | 4                  | Jean        | To Do  |
| EP4/US7    | Soporte para múltiples bases de datos en el backend          | T30     | Migrar datos existentes a nuevas bases de datos si es necesario | Transferir los datos actuales a las nuevas bases de datos configuradas                           | 4                  | Franco      | To Do  |
| EP4/US7    | Soporte para múltiples bases de datos en el backend          | T31     | Realizar pruebas de integración y rendimiento                 | Ejecutar pruebas para asegurar que las múltiples bases de datos funcionan correctamente y no afectan el rendimiento | 4                  | Lino        | To Do  |
| EP4/US8    | Generación de reportes basados en condiciones críticas      | T32     | Definir las condiciones críticas para generación de reportes   | Establecer qué condiciones se consideran críticas para la generación automática de reportes    | 3                  | Miguel      | To Do  |
| EP4/US8    | Generación de reportes basados en condiciones críticas      | T33     | Implementar la lógica para detección de condiciones críticas | Desarrollar la lógica que identifica condiciones críticas en los cultivos para generar reportes | 4                  | Giovanni    | To Do  |
| EP4/US8    | Generación de reportes basados en condiciones críticas      | T34     | Desarrollar la funcionalidad de generación automática de reportes | Crear la funcionalidad que genera reportes automáticamente cuando se detectan condiciones críticas | 4                  | Jean        | To Do  |
| EP4/US8    | Generación de reportes basados en condiciones críticas      | T35     | Realizar pruebas de generación y envío de reportes            | Ejecutar pruebas para asegurar que los reportes se generan y envían correctamente cuando se detectan condiciones críticas | 4                  | Franco      | To Do  |
| EP5/US2    | Control local de dispositivos IoT                          | T36     | Diseñar la interfaz de control local en la app embebida        | Crear la interfaz de usuario para el control local de dispositivos IoT desde la app embebida   | 4                  | Miguel      | To Do  |
| EP5/US2    | Control local de dispositivos IoT                          | T37     | Implementar la lógica de comunicación local con dispositivos IoT | Desarrollar la lógica que permite la comunicación directa con dispositivos IoT desde la app embebida | 4                  | Giovanni    | To Do  |
| EP5/US2    | Control local de dispositivos IoT                          | T38     | Desarrollar funcionalidades de control manual de dispositivos   | Crear las funcionalidades que permiten a los usuarios controlar manualmente los dispositivos IoT | 4                  | Jean        | To Do  |
| EP5/US2    | Control local de dispositivos IoT                          | T39     | Realizar pruebas de control sin conexión a internet             | Ejecutar pruebas para asegurar que el control local funciona correctamente sin conexión a internet | 4                  | Lino        | To Do  |
| EP5/US3    | Actualización automática de firmware de dispositivos       | T40     | Diseñar el proceso de actualización de firmware                 | Definir cómo se realizará la actualización automática de firmware en los dispositivos IoT    | 4                  | Miguel      | To Do  |
| EP5/US3    | Actualización automática de firmware de dispositivos       | T41     | Implementar la lógica de descarga y aplicación de firmware      | Desarrollar la funcionalidad que permite la descarga y aplicación automática de firmware en los dispositivos | 4                  | Giovanni    | To Do  |
| EP5/US3    | Actualización automática de firmware de dispositivos       | T42     | Desarrollar mecanismos de verificación de integridad del firmware | Crear mecanismos que aseguren la integridad del firmware antes y después de la actualización | 4                  | Jean        | To Do  |
| EP5/US3    | Actualización automática de firmware de dispositivos       | T43     | Realizar pruebas de actualización en diferentes dispositivos    | Ejecutar pruebas para asegurar que la actualización automática de firmware funciona correctamente en diversos dispositivos IoT | 4                  | Lino        | To Do  |
| EP5/US4    | Operación desconectada de la aplicación embebida           | T44     | Diseñar la arquitectura para operación sin conexión             | Definir cómo la aplicación embebida continuará funcionando sin conexión a internet            | 4                  | Miguel      | To Do  |
| EP5/US4    | Operación desconectada de la aplicación embebida           | T45     | Implementar almacenamiento local de datos en la app embebida      | Desarrollar la funcionalidad que permite almacenar datos localmente cuando no hay conexión a internet | 4                  | Giovanni    | To Do  |
| EP5/US4    | Operación desconectada de la aplicación embebida           | T46     | Desarrollar funcionalidades que operen sin conexión               | Crear las funcionalidades principales de la app embebida que pueden operar sin conexión       | 4                  | Jean        | To Do  |
| EP5/US4    | Operación desconectada de la aplicación embebida           | T47     | Integrar sincronización de datos una vez restaurada la conexión    | Conectar la funcionalidad de sincronización para que los datos locales se sincronicen con el backend una vez que se restablece la conexión | 4                  | Franco      | To Do  |
| EP5/US4    | Operación desconectada de la aplicación embebida           | T48     | Realizar pruebas de operación en modo offline                     | Ejecutar pruebas para asegurar que la aplicación embebida funciona correctamente en modo offline | 4                  | Lino        | To Do  |
| EP5/US5    | Implementación de failover en dispositivos embebidos       | T49     | Diseñar el sistema de failover para dispositivos embebidos         | Definir cómo se manejará el failover en caso de fallos en los dispositivos embebidos         | 4                  | Miguel      | To Do  |
| EP5/US5    | Implementación de failover en dispositivos embebidos       | T50     | Implementar lógica de detección de fallos en dispositivos           | Desarrollar la lógica que detecta fallos en los dispositivos embebidos                     | 4                  | Giovanni    | To Do  |
| EP5/US5    | Implementación de failover en dispositivos embebidos       | T51     | Desarrollar mecanismos de conmutación automática                    | Crear mecanismos que permitan la conmutación automática en caso de fallos                    | 4                  | Jean        | To Do  |
| EP5/US5    | Implementación de failover en dispositivos embebidos       | T52     | Realizar pruebas de resiliencia y continuidad                        | Ejecutar pruebas para asegurar que el sistema de failover funciona correctamente y mantiene la continuidad del servicio | 4                  | Lino        | To Do  |
| EP5/US6    | Soporte para múltiples tipos de sensores en dispositivos embebidos | T53     | Identificar y documentar los tipos de sensores a soportar             | Enumerar y documentar los diferentes tipos de sensores IoT que se integrarán en la aplicación embebida | 3                  | Miguel      | To Do  |
| EP5/US6    | Soporte para múltiples tipos de sensores en dispositivos embebidos | T54     | Diseñar la arquitectura para integración de múltiples sensores      | Definir cómo se integrarán los diferentes tipos de sensores en la arquitectura de la aplicación embebida | 4                  | Giovanni    | To Do  |
| EP5/US6    | Soporte para múltiples tipos de sensores en dispositivos embebidos | T55     | Implementar drivers para cada tipo de sensor                         | Desarrollar drivers específicos para cada tipo de sensor IoT soportado                      | 4                  | Jean        | To Do  |
| EP5/US6    | Soporte para múltiples tipos de sensores en dispositivos embebidos | T56     | Desarrollar la lógica de procesamiento de datos de sensores           | Crear la lógica que procesa los datos recibidos de los diferentes tipos de sensores            | 4                  | Franco      | To Do  |
| EP5/US6    | Soporte para múltiples tipos de sensores en dispositivos embebidos | T57     | Realizar pruebas de integración con diferentes sensores                | Ejecutar pruebas para asegurar que todos los tipos de sensores funcionan correctamente con la aplicación embebida | 4                  | Lino        | To Do  |
| EP6/US1    | Balanceo de carga en backend distribuido                   | T58     | Diseñar la estrategia de balanceo de carga                           | Definir cómo se distribuirá la carga entre los servidores backend                            | 4                  | Miguel      | To Do  |
| EP6/US1    | Balanceo de carga en backend distribuido                   | T59     | Implementar el balanceador de carga (hardware/software)               | Configurar e implementar el balanceador de carga elegido (e.g., Nginx, HAProxy)               | 4                  | Giovanni    | To Do  |
| EP6/US1    | Balanceo de carga en backend distribuido                   | T60     | Configurar servidores backend para balanceo                           | Ajustar la configuración de los servidores backend para que funcionen con el balanceador de carga | 4                  | Jean        | To Do  |
| EP6/US1    | Balanceo de carga en backend distribuido                   | T61     | Integrar el balanceador con la infraestructura existente               | Conectar el balanceador de carga con la infraestructura de servidores actual                   | 4                  | Franco      | To Do  |
| EP6/US1    | Balanceo de carga en backend distribuido                   | T62     | Realizar pruebas de distribución de carga y rendimiento                | Ejecutar pruebas para asegurar que la carga se distribuye correctamente y que el rendimiento es óptimo | 4                  | Lino        | To Do  |
| EP6/US2    | Gestión de métricas de rendimiento                         | T63     | Definir las métricas clave de rendimiento a monitorizar               | Identificar las métricas más importantes para evaluar el rendimiento del backend              | 3                  | Miguel      | To Do  |
| EP6/US2    | Gestión de métricas de rendimiento                         | T64     | Implementar herramientas de recolección de métricas                   | Configurar herramientas como Prometheus, Grafana o similares para recolectar las métricas definidas | 4                  | Giovanni    | To Do  |
| EP6/US2    | Gestión de métricas de rendimiento                         | T65     | Diseñar dashboards para visualización de métricas                      | Crear dashboards que muestren las métricas de rendimiento de manera clara y accesible        | 4                  | Jean        | To Do  |
| EP6/US2    | Gestión de métricas de rendimiento                         | T66     | Integrar la gestión de métricas con el sistema de alertas              | Configurar alertas basadas en las métricas recolectadas para notificar al equipo sobre posibles problemas | 4                  | Franco      | To Do  |
| EP6/US2    | Gestión de métricas de rendimiento                         | T67     | Realizar pruebas de precisión y actualización de métricas              | Ejecutar pruebas para asegurar que las métricas se recolectan y actualizan correctamente       | 4                  | Lino        | To Do  |
| EP6/US3    | Monitoreo de fallos en el backend distribuido              | T68     | Diseñar el sistema de monitoreo de fallos                             | Definir cómo se detectarán y monitorearán los fallos en el backend distribuido                 | 4                  | Miguel      | To Do  |
| EP6/US3    | Monitoreo de fallos en el backend distribuido              | T69     | Implementar detección automática de fallos                            | Desarrollar la funcionalidad que detecta automáticamente los fallos en el backend              | 4                  | Giovanni    | To Do  |
| EP6/US3    | Monitoreo de fallos en el backend distribuido              | T70     | Desarrollar alertas para notificación de fallos                        | Crear alertas que notifiquen al equipo cuando se detecten fallos en el backend                 | 4                  | Jean        | To Do  |
| EP6/US3    | Monitoreo de fallos en el backend distribuido              | T71     | Integrar monitoreo con herramientas de logging                         | Conectar el sistema de monitoreo de fallos con las herramientas de logging existentes          | 4                  | Franco      | To Do  |
| EP6/US3    | Monitoreo de fallos en el backend distribuido              | T72     | Realizar pruebas de detección y respuesta a fallos                      | Ejecutar pruebas para asegurar que los fallos se detectan y se responden adecuadamente          | 4                  | Lino        | To Do  |
| EP6/US4    | Configuración de múltiples servidores backend               | T73     | Identificar los requisitos para servidores adicionales                 | Determinar los requisitos necesarios para agregar nuevos servidores backend                    | 4                  | Miguel      | To Do  |
| EP6/US4    | Configuración de múltiples servidores backend               | T74     | Configurar nuevos servidores backend                                  | Instalar y configurar los nuevos servidores backend según los requisitos definidos            | 4                  | Giovanni    | To Do  |
| EP6/US4    | Configuración de múltiples servidores backend               | T75     | Implementar sincronización entre servidores                            | Desarrollar la lógica que sincroniza datos entre los diferentes servidores backend              | 4                  | Jean        | To Do  |
| EP6/US4    | Configuración de múltiples servidores backend               | T76     | Integrar nuevos servidores con el balanceador de carga                 | Conectar los nuevos servidores backend con el balanceador de carga existente                   | 4                  | Franco      | To Do  |
| EP6/US4    | Configuración de múltiples servidores backend               | T77     | Realizar pruebas de integración y rendimiento                          | Ejecutar pruebas para asegurar que los nuevos servidores funcionan correctamente y no afectan el rendimiento general | 4                  | Lino        | To Do  |
| EP6/US5    | Integración de API para el backend distribuido              | T78     | Diseñar la arquitectura de la API REST                                 | Definir la estructura y endpoints de la API REST para el backend distribuido                  | 4                  | Miguel      | To Do  |
| EP6/US5    | Integración de API para el backend distribuido              | T79     | Implementar endpoints de la API                                         | Desarrollar los diferentes endpoints necesarios para la API REST                                | 4                  | Giovanni    | To Do  |
| EP6/US5    | Integración de API para el backend distribuido              | T80     | Desarrollar documentación de la API                                      | Crear documentación clara y detallada para la API REST desarrollada                             | 4                  | Jean        | To Do  |
| EP6/US5    | Integración de API para el backend distribuido              | T81     | Realizar pruebas de funcionalidad y seguridad de la API                  | Ejecutar pruebas para asegurar que la API REST funciona correctamente y es segura                | 4                  | Franco      | To Do  |
| EP6/US6    | Configuración de redundancia en el backend distribuido      | T82     | Diseñar la estrategia de redundancia para servidores backend             | Definir cómo se implementará la redundancia para asegurar la disponibilidad de los servidores backend | 4                  | Miguel      | To Do  |
| EP6/US6    | Configuración de redundancia en el backend distribuido      | T83     | Implementar servidores de respaldo                                       | Configurar servidores de respaldo que puedan asumir la carga en caso de fallo                  | 4                  | Giovanni    | To Do  |
| EP6/US6    | Configuración de redundancia en el backend distribuido      | T84     | Configurar replicación de datos entre servidores                         | Establecer la replicación de datos para mantener la coherencia entre servidores                 | 4                  | Jean        | To Do  |
| EP6/US6    | Configuración de redundancia en el backend distribuido      | T85     | Integrar redundancia con el balanceador de carga                         | Conectar los servidores de respaldo con el balanceador de carga para gestionar la redundancia   | 4                  | Franco      | To Do  |
| EP6/US6    | Configuración de redundancia en el backend distribuido      | T86     | Realizar pruebas de failover y continuidad                                | Ejecutar pruebas para asegurar que la redundancia funciona correctamente y que el sistema continúa operando sin interrupciones | 4                  | Lino        | To Do  |
| EP6/US7    | Optimización del tiempo de respuesta del backend            | T87     | Analizar los tiempos actuales de respuesta del backend                   | Evaluar los tiempos de respuesta actuales para identificar áreas de mejora                      | 4                  | Miguel      | To Do  |
| EP6/US7    | Optimización del tiempo de respuesta del backend            | T88     | Identificar cuellos de botella en el procesamiento                        | Detectar y documentar los principales cuellos de botella que afectan el rendimiento del backend  | 4                  | Giovanni    | To Do  |
| EP6/US7    | Optimización del tiempo de respuesta del backend            | T89     | Implementar mejoras en la distribución de carga                          | Desarrollar e implementar estrategias para mejorar la distribución de la carga entre servidores | 4                  | Jean        | To Do  |
| EP6/US7    | Optimización del tiempo de respuesta del backend            | T90     | Optimizar consultas y operaciones de base de datos                        | Revisar y optimizar las consultas y operaciones en la base de datos para mejorar el rendimiento | 4                  | Franco      | To Do  |
| EP6/US7    | Optimización del tiempo de respuesta del backend            | T91     | Realizar pruebas de rendimiento post-optimización                         | Ejecutar pruebas para verificar que las optimizaciones han mejorado el tiempo de respuesta     | 4                  | Lino        | To Do  |
| EP6/US8    | Implementación de colas de mensajes para el backend         | T92     | Diseñar la arquitectura de colas de mensajes                             | Definir cómo se implementarán las colas de mensajes (e.g., RabbitMQ, Kafka) en el backend        | 4                  | Miguel      | To Do  |
| EP6/US8    | Implementación de colas de mensajes para el backend         | T93     | Implementar el sistema de colas                                         | Configurar e implementar la herramienta de colas de mensajes seleccionada                       | 4                  | Giovanni    | To Do  |
| EP6/US8    | Implementación de colas de mensajes para el backend         | T94     | Integrar colas de mensajes con servicios backend                         | Conectar las colas de mensajes con los servicios backend para gestionar las solicitudes        | T95      | Jean        | To Do  |
| EP6/US8    | Implementación de colas de mensajes para el backend         | T96     | Desarrollar lógica para gestión de mensajes                              | Crear la lógica que maneja el encolado y procesamiento de mensajes en el backend                | 4                  | Franco      | To Do  |
| EP6/US8    | Implementación de colas de mensajes para el backend         | T97     | Realizar pruebas de manejo de carga y recuperación                       | Ejecutar pruebas para asegurar que las colas de mensajes manejan correctamente la carga y se recuperan ante fallos | 4                  | Lino        | To Do  |
| EP6/US9    | Configuración de monitoreo de tráfico en el backend         | T98     | Definir los parámetros de tráfico a monitorizar                         | Establecer qué aspectos del tráfico de datos serán monitorizados                             | 3                  | Miguel      | To Do  |
| EP6/US9    | Configuración de monitoreo de tráfico en el backend         | T99     | Implementar herramientas de monitoreo de tráfico                        | Configurar herramientas como Wireshark, Netdata o similares para monitorear el tráfico de datos  | 4                  | Giovanni    | To Do  |
| EP6/US9    | Configuración de monitoreo de tráfico en el backend         | T100    | Diseñar dashboards para visualización de tráfico                        | Crear dashboards que muestren el tráfico de datos de manera clara y comprensible                | 4                  | Jean        | To Do  |
| EP6/US9    | Configuración de monitoreo de tráfico en el backend         | T101    | Integrar monitoreo con el sistema de alertas                             | Conectar el monitoreo de tráfico con el sistema de alertas para notificar sobre anomalías        | 4                  | Franco      | To Do  |
| EP6/US9    | Configuración de monitoreo de tráfico en el backend         | T102    | Realizar pruebas de monitoreo y ajustes necesarios                        | Ejecutar pruebas para asegurar que el monitoreo de tráfico funciona correctamente y realizar ajustes si es necesario | 4                  | Lino        | To Do  |
