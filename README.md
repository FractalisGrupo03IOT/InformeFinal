...
| -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Criterio 1: Trabaja en equipo para proporcionar liderazgo en forma conjunta**                                | **TB1**: <br> - **Miguel Ángel** Coordinó las primeras reuniones y asignó roles, asegurándose de que el equipo entendiera sus tareas, con un enfoque en la **landing page** y partes iniciales de la **web app**. <br> - **Lino Quenta** Diseñó el marco de trabajo y supervisó la estructura de la **landing page**, aportando a su desarrollo visual. <br> - **Giovanni Andrés** Apoyó en el desarrollo y cohesión del código para la **web app**, ajustando funcionalidades clave. <br> - **Jean Patrick** Lideró la implementación inicial de los aspectos técnicos de la **web app**, asegurándose de que la estructura técnica fuera adecuada. <br> - **Franco** Finalizó la **landing page**, revisando detalles visuales y optimizando la experiencia del usuario. <br> **TP1**: <br> - **Miguel Ángel** Diseñó la planificación del trabajo en la **web app** más completa y en la actualización de la **landing page**, asignando roles específicos. <br> - **Lino Quenta** Mejoró el diseño UX de la **landing page** y coordinó mejoras en los componentes. <br> - **Giovanni Andrés** Amplió la funcionalidad en el backend de la **web app**, asegurando estabilidad. <br> - **Jean Patrick** Refinó aspectos técnicos avanzados en el backend. <br> - **Franco** Supervisó la estética de la **landing page** y partes visuales de la **web app**. <br> **TB2**: <br> - **Miguel Ángel** Aseguró la integración del **backend** y la funcionalidad del **edge server**. <br> - **Lino Quenta** Supervisó las conexiones entre el **backend** y la **web app**, enfocándose en optimizar la comunicación entre sistemas. <br> - **Giovanni Andrés** Se encargó del desarrollo técnico del **edge server** y las bases del backend. <br> - **Jean Patrick** Desarrolló e integró funcionalidades específicas en la **mobile app**, alineándolas con los sistemas previos. <br> - **Franco** Coordinó y aportó al diseño de la **mobile app**, optimizando su experiencia visual. <br> **TF**: <br> - **Miguel Ángel** Aseguró la cohesión general del proyecto, integrando aportes entre la **web app** y la **mobile app**. <br> - **Lino Quenta** Refinó detalles en el diseño UX de la **web app** más completa. <br> - **Giovanni Andrés** Lideró el backend y aseguró la funcionalidad avanzada en el **edge server**. <br> - **Jean Patrick** Supervisó e implementó módulos en la **mobile app**, completando la funcionalidad técnica. <br> - **Franco** Revisó el diseño final, tanto de la **web app** como de la **mobile app**, asegurando una presentación visual impecable. | El equipo distribuyó responsabilidades de manera equilibrada, permitiendo que cada integrante liderara en su área de especialidad. Este liderazgo conjunto fortaleció tanto la **web app** como la **mobile app**, logrando resultados funcionales y estéticos. |
| **Criterio 2: Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **TB1**: <br> - **Miguel Ángel** Creó un cronograma para los entregables de la **landing page** y la **web app**, asignando tareas claras. <br> - **Lino Quenta** Fomentó sesiones de brainstorming, promoviendo la participación inclusiva para la **landing page**. <br> - **Giovanni Andrés** Supervisó avances técnicos de la **web app** para mantener los plazos acordados. <br> - **Jean Patrick** Estableció estándares técnicos claros para el desarrollo inicial. <br> - **Franco** Facilitó reuniones para alinear al equipo con los objetivos visuales. <br> **TP1**: <br> - **Miguel Ángel** Estableció metas detalladas para la mejora de la **web app** y **landing page**. <br> - **Lino Quenta** Promovió revisiones inclusivas para garantizar una colaboración óptima. <br> - **Giovanni Andrés** Validó que las tareas técnicas se alinearan con las metas. <br> - **Jean Patrick** Supervisó los aspectos técnicos más críticos. <br> - **Franco** Programó revisiones de progreso para cumplir el cronograma. <br> **TB2**: <br> - **Miguel Ángel** Estableció objetivos para integrar el **backend**, el **edge server**, y la **mobile app**. <br> - **Lino Quenta** Facilitó la integración de ideas entre el equipo para resolver desafíos técnicos. <br> - **Giovanni Andrés** Implementó tareas técnicas clave en el **edge server**. <br> - **Jean Patrick** Lideró aspectos funcionales de la **mobile app**. <br> - **Franco** Aseguró la calidad visual del diseño en cada aplicación. <br> **TF**: <br> - **Miguel Ángel** Planificó hitos y cronogramas finales para integrar la **web app** y la **mobile app** completas. <br> - **Lino Quenta** Promovió un ambiente inclusivo durante las etapas de ajuste y refinamiento. <br> - **Giovanni Andrés** Coordinó la funcionalidad avanzada del backend y el **edge server**. <br> - **Jean Patrick** Aseguró que las funcionalidades de la **mobile app** cumplieran con los estándares definidos. <br> - **Franco** Finalizó revisiones visuales y estructurales en ambas aplicaciones.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | La colaboración y comunicación constante dentro del equipo aseguraron que todos los miembros estuvieran alineados con los objetivos, promoviendo un ambiente productivo y eficiente para alcanzar los entregables.                                              |
