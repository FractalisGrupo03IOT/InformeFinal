...
- **Resumen de la entrevista**: Griselda Flores, agricultora de 28 años de Puno, se enfoca en el monocultivo. Probó la aplicación para la gestión de estaciones y sensores para monitorear su cultivo, valorando la capacidad de registrar manualmente datos históricos. Sugirió que la sección de asesoramiento técnico podría mejorar para beneficiar a otros agricultores de su región.
...
- **Resumen de la entrevista**: Sonia Cayhulla, de 30 años y monocultivadora de hortalizas en Puno, encontró útil la aplicación para gestionar estaciones y monitorear en tiempo real el riego y nutrientes de sus cultivos. Mencionó que una capacitación sobre el uso de la aplicación podría ayudar a maximizar sus beneficios, especialmente en el riego automatizado.
